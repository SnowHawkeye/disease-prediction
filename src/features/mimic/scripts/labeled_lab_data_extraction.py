...
def main():
    EXTRACTION_CONFIG_FILEPATH = "config/34-prediction-performance/most_common_analyses/ckd/ckd_B24m_G3m_P5y/ckd_B24m_G3m_P5y_config.json"
    PATH_CONFIG_FILEPATH = "config/34-prediction-performance/most_common_analyses/ckd/ckd_B24m_G3m_P5y/ckd_B24m_G3m_P5y_paths.json"
